...
class LancLocalAdapter extends TypeAdapter<LancLocal> {
  ...
  LancLocal read(BinaryReader reader) {
    ...
    return LancLocal(
      ...
      localizacaoId: fields[21] as String?,
      localizacaoNome: fields[22] as String?,
      comentario: fields[23] as String?,
      ordemServico: fields[24] as String?,
    );
  }
  ...
  void write(BinaryWriter writer, LancLocal obj) {
    writer
      ...
      ..writeByte(21)
      ..write(obj.localizacaoId)
      ..writeByte(22)
      ..write(obj.localizacaoNome)
      ..writeByte(23)
      ..write(obj.comentario)
      ..writeByte(24)
      ..write(obj.ordemServico);
  }
